...
import de.irisnet.java.client.auth.Authentication;
import de.irisnet.java.client.auth.ApiKeyAuth;
import de.irisnet.java.client.auth.HttpBasicAuth;
import de.irisnet.java.client.request.GetRequest;
import de.irisnet.java.client.request.PostRequest;
import de.irisnet.java.client.request.PutRequest;
import de.irisnet.java.client.request.DeleteRequest;
import de.irisnet.java.client.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    setUserAgent("OpenAPI-Generator/3.4.2/android");

    // Setup authentications (key: authentication name, value: authentication).
    INSTANCE.authentications = new HashMap<String, Authentication>();
    INSTANCE.authentications.put("LICENSE-KEY", new ApiKeyAuth("header", "LICENSE-KEY"));
