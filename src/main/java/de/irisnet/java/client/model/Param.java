...
public class Param {
  ...
  public enum ClassificationEnum {
     face,  hand,  foot,  footwear,  chest,  breast,  vulva,  penis,  vagina,  buttocks,  anus,  oral,  penetration,  toy,  child,  adult,  senior,  pose,  female,  male,  hair,  hairless,  beard,  moustache,  headpiece,  glasses,  sunglasses,  mask,  slimSized,  realSized,  plusSized,  noNipple,  hasNipple,  beer,  beerBottle,  beerCan,  wine,  wineBottle,  cocktail,  alcohol,  cannabis,  cigarette,  cocaine,  heroine,  coffee,  camouflage,  club,  knife,  sword,  pistol,  rifle,  cannon,  fire,  nudityCheck,  ageVerification,  ageEstimation,  illegalSymbols,  textRecognition,  attributesCheck,  bodyAttributes,  nippleCheck,  unwantedSubstances,  violenceCheck, 
  };
